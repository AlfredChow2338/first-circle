# react-compiler-vite-build Specification

## Purpose

Build-time integration of the React Compiler with Vite for client React/TSX, using the supported `@vitejs/plugin-react` v6 path (Babel + `reactCompilerPreset`), without dropping Vanilla Extract, PWA, or path-alias behavior.
