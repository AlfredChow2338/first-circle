# csv-upload-read-resilience Specification

## Purpose

Client-side CSV file read resilience: bounded retries with backoff, then rollback and clear user guidance to upload again.
